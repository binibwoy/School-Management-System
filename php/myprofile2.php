    ...
    {   
        ...
        if($imgFile)
        {
            ...
            {           
                if($imgSize < 5000000)
                {
                    unlink($upload_dir.$edit_row['staffPic']);
        ...
        else
        {
            ...
            $staffpic = $edit_row['staffPic']; // old image from database
        }   
            ...
            <div class="container-fluid">
                ...
                <div class="clearfix"></div>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <a href="../php/update2.php?edit_id=<?php echo $staffName; ?>">
